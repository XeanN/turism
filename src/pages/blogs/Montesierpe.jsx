    ...
    <div className="blog-content">
        ...
        <div>
            ...
            <div className="content-box">
                <h2>The geoglyphs at Monte Sierpe are amongst Peru's most enigmatic and unexplainable mysteries</h2>
                <p>
                    The Avenida de los Hoyos, a geoglyph like the Nazca lines consisting of a series of large basin-like potholes along a mountain ridge, appears to slither up the slope for miles.    
                </p>
            </div>
            <div className="quote-block">
                <em>
                    “I believe that what appears to be a serpent is actually the deity Q'hoa. He was the servant or acolyte of the god of water known as Illapa and his likeness was used in a majority of rituals regarding rain”.
                </em>
            </div>   
        </div>

        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_6_t.jpg" alt="Monte Sierpe" className="blog-image" style={{ width: '250px', borderRadius: '6px' }} />
            <div className="content-box">
                <p>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/tambo_colorado_1_t.jpg" alt="Tambo Colorado" className="blog-image" />

            <div className="content-box">
                <p>
                    At Tambo Colorado we discover a vast site with many crude tombs. 
                    <strong> “Tambo Colorado has been dated during the Inca period</strong> however it is important to remember that while the Incas were conquerers, they did not always conquer other cultures by force” explains Lucio.
                </p>

                <p>
                    Rather, the Incas forged a powerful relationship with the Chincas who were the dominating culture of the area in the time.
                    “They built structures in harmony with older sacred sites to forge their relationship with the inhabitants and we see that here in Tambo Colorado, structures in the style of Inca beside much older structures and crude tombs built prior to and not in the finer Inca style” concludes Lucio.
                </p>

                <p>
                    While artifacts and burials from the Inca period have been found in the tombs themselves, Lucio feels that the tombs are likely pre-inca and likely thousands of years old.
                </p>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_church_1_portrait.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “The town [Monte Sierpe] was destroyed by the earthquake, not a single building was left standing”
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_1_t.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        The name 'Avenida de los Hoyos' was coined by Peru's famous archaeologist Federico Kaufman Doig when he studied the site in the 1930's
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_2_t.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_4_portrait.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_4_t.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “The head of the serpent … only becomes clear from a certain point and certain time of day”
                    </em>
                </div>
            </div>
        </div>
         ...
         <div className="section-horizontal">
            <img src="/tour-images/Paracas//monte_sierpe_flor_t.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_8_t.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_summit_portrait.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “what appears to be a serpent is actually the ancient deity Q'hoa. He was the servant … of the god of water … and was used in … rituals regarding rain”
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/monte_sierpe_9_t.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/qhoa_1_t.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “He took many forms but he is consistently depicted with a body comprising of concentric circles that represent water"
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/qhoa_2_t.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “Civilizations may come to an end but people and cultures simply do not just disappear"
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/qhoa_3_t.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “Human survival and success demands that we seek greener pastures”
                    </em>
                </div>
            </div>
        </div>
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/qhoa_4_t.jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/cantalloc_2_t (1).jpg" alt="Monte Sierpe" className="blog-image" />
        ...
        <div className="section-horizontal">
            <img src="/tour-images/Paracas/nazca_mono_portrait.jpg" alt="Monte Sierpe" className="blog-image" />
            ...
            <div className="content-box">
                ...
                <div className="quote-block">
                    <em>
                        “Nanazca is a word in Quechua which means pain or suffering” 
                    </em>
                </div>
            </div>
        </div>
