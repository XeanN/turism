  ...
  return (
    <div className="blog-content">
        ...
        <div className="blog-section">
            <img src="/tour-images/Paracas/monte_sierpe_6_t.jpg" alt="Monte Sierpe" className="float-image" />
            <div className="content-box">
                <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/tambo_colorado_1_t.jpg" alt="Tambo Colorado" className="image-left" />

            <div className="quote-box">
                <em>“They [the Inca] built structures in harmony with older sacred sites to forge their relationship with the inhabitants …”</em>
            </div>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_church_1_portrait.jpg" alt="Monte Sierpe" className="image-left" />
        ...
        <div className="intro-paragraph">
            ...
            <div className="quote-box">
                <em>The name 'Avenida de los Hoyos' was coined by Peru's famous archaeologist Federico Kaufman Doig when he studied the site in the 1930's</em>
            </div>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_2_t.jpg" alt="Monte Sierpe" className="image-left" />
                <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_4_portrait.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>“The town [Monte Sierpe] was destroyed by the earthquake, not a single building was left standing”</em>
            </div>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_4_t.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>“The head of the serpent … only becomes clear from a certain point and certain time of day”</em>
            </div>
            <p>
         ...
         <div className="intro-paragraph">
            <img src="/tour-images/Paracas//monte_sierpe_flor_t.jpg" alt="Monte Sierpe" className="image-left" />
            <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_8_t.jpg" alt="Monte Sierpe" className="image-left" />
            <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_summit_portrait.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/monte_sierpe_9_t.jpg" alt="Monte Sierpe" className="image-left" />
            <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/qhoa_1_t.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/qhoa_2_t.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/qhoa_3_t.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/qhoa_4_t.jpg" alt="Monte Sierpe" className="image-left" />
            <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/cantalloc_2_t (1).jpg" alt="Monte Sierpe" className="image-left" />
            <p>
        ...
        <div className="intro-paragraph">
            <img src="/tour-images/Paracas/nazca_mono_portrait.jpg" alt="Monte Sierpe" className="image-left" />
            <div className="quote-box">
                <em>
